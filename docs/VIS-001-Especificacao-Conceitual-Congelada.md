...
PARTE 2 de 5 — Ctrl+End primeiro, depois cole:
...
- Integração automática com ONR/SREI, ARISP, CNIB, TJAL — fora (already registered as future work no README do Módulo PEI)
